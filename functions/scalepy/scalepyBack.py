...
def parameterCreator(lat, lon, intensity):
    ...
    afad_spectra_params_df = pd.read_csv("data/scalepy/afadParameters.csv")
...
def targetSpectrum(Ss, S1, soil):
    ...
    x_spectra = pd.read_csv("data/scalepy/spectral_x.csv")
...
def recordSelection(magnitude_range: str = '4 9',
    ...
    """
    # Read the Meta Data
    eqe_df = pd.read_csv("data/scalepy/meta_data-R1.csv")
    ...
    # Read Spectral Data
    spectral_data_x = pd.read_csv("data/scalepy/spectral_x.csv")
    spectral_data_y = pd.read_csv("data/scalepy/spectral_y.csv")
